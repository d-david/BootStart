...
$args['page_title'] = __('BootStart Theme Options', 'nhp-opts');
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => '6',
						'type' => 'textarea',
						'title' => __('Copyright Text - HTML Validated', 'nhp-opts'), 
						'sub_desc' => __('HTML Allowed (wp_kses)', 'nhp-opts'),
						'desc' => __('Choose your copyrights text.', 'nhp-opts'),
